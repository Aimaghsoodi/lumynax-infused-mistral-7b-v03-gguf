...
[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-infused-mistral-7b-v03-gguf) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-infused-mistral-7b-v03-gguf` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-infused-mistral-7b-v03-gguf --local-dir lumynax-infused-mistral-7b-v03-gguf
cd lumynax-infused-mistral-7b-v03-gguf && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-infused-mistral-7b-v03-gguf -i
```
